...
public class Activity_HomeScreen extends AppCompatActivity implements ObservableScrollViewCallbacks,NavigationView.OnNavigationItemSelectedListener ,Fragement_HomeScreen.OnListItemSelectedListener, Fragment_Filter.OnFilterAppliedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(bundleData!=null) {
            ...
            fab_camera = (ImageView) findViewById(R.id.camera);
            fab_gallery = (ImageView) findViewById(R.id.gallery);
            fab_close = (ImageView) findViewById(R.id.fab_close);
